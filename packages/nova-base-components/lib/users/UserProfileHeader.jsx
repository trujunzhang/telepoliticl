...
class UserProfileHeader extends Component {
    ...
    render() {
        return (
                ...
                <div className="constraintWidth_ZyYbM constraintWidth_2VQxE" >
                    <header className="backgroundImage_1hK9M header_21q-l">
                        <span className="user-image image_1r8-2 v-big">
                            <div className="container_22rD3 user-image--image" >
                                <div className="container__Ql6q lazyLoadContainer_3KgZD">
                                    <img height="140" src="./Product Hunt_files/original(2)" width="140"/>
                                </div>
                                <img className="placeholder_E_0qw placeholderHidden_pb7Bz" height="140" src="./Product Hunt_files/original(3)" width="140"/>
                            </div>
                        </span>
                        <div className="info_2UynN">
                            ...
                            <h2 className="username_3tQri featured_2W7jd inverse_1CN6F base_3CbW2"><!-- react-text: 780 -->@ trujunzhang</h2>
                            <p className="secondary_Yuxa5 text_3Wjo0 inverse_1CN6F base_3CbW2">I'm a freelancer, http://www.scruby.site
                                <a className="twitter_3_mOY" href="https://twitter.com/TrujunZhang" rel="user-twitter" target="_blank">
                                    <span>
                        ...
                        <div className="social_1SKRS">
                            <a className="counter_1BMTv text_3Wjo0 inverse_1CN6F base_3CbW2" href="https://www.producthunt.com/@trujunzhang/following">
                                <strong>5</strong>
                                Following
                            </a>
                            <a className="counter_1BMTv text_3Wjo0 inverse_1CN6F base_3CbW2" href="https://www.producthunt.com/@trujunzhang/followers">
                                <strong>0</strong>
                                Followers</a>
                            <a className="button_2I1re mediumSize_10tzU secondaryBoldText_1PBCf secondaryText_PM80d simpleVariant_1Nl54" href="https://www.producthunt.com/my/settings/edit">
            ...
            ) } } UserProfileHeader.contextTypes = {messages : React.PropTypes.object
}
